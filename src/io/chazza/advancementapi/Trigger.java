...
public class Trigger {
	...
	public JsonObject toJsonObject() {
		...
		triggerObj.addProperty("trigger", "minecraft:" + type.toString().toLowerCase());
	...
	public static enum TriggerType {
		ARBITRARY_PLAYER_TICK, BRED_ANIMALS, BREWED_POTION, CHANGED_DIMENSION, CONSTRUCT_BEACON, CONSUME_ITEM, CURED_ZOMBIE_VILLAGER, ENCHANTED_ITEM, ENTER_BLOCK, ENTITY_HURT_PLAYER, ENTITY_KILLED_PLAYER, IMPOSSIBLE, INVENTORY_CHANGED, ITEM_DURABILITY_CHANGED, LEVITATION, LOCATION, PLACED_BLOCK, PLAYER_HURT_ENTITY, PLAYER_KILLED_ENTITY, RECIPE_UNLOCKED, SLEPT_IN_BED, SUMMONED_ENTITY, TAME_ANIMAL, TICK, USED_ENDER_EYE, VILLAGER_TRADE
	}
	...
	public static class TriggerBuilder {
		...
		public String toString() {
			return "io.chazza.advancementapi.Trigger.TriggerBuilder(type=" + type + ", name=" + name + ", conditions=" + conditions + ")";
		}
	}
}