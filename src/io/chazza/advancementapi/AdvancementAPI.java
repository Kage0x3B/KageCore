...
public class AdvancementAPI {
	...
	public void save(World world) {
		File file = new File(world.getWorldFolder(), "data" + File.separator + "advancements" + File.separator + id.getNamespace() + File.separator + id.getKey() + ".json");
	...
	public static class AdvancementAPIBuilder {
		...
		public String toString() {
			return "io.chazza.advancementapi.AdvancementAPI.AdvancementAPIBuilder(id=" + id + ", parent=" + parent + ", icon=" + icon + ", background=" + background + ", title=" + title + ", description=" + description + ", frame=" + frame + ", announce=" + announce + ", toast=" + toast + ", hidden=" + hidden + ", counter=" + counter + ", triggers=" + triggers + ")";
		}
	}
