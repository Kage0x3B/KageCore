...
public enum ParticleEffect {
	...
	public boolean isSupported() {
		...
		return ParticlePacket.getMinorVersion() >= requiredVersion;
	}
	...
	public static final class ParticlePacket {
		...
		private static Reflect enumParticleClass;
		private static Reflect packetClass;
		...
		public static void initialize() throws VersionIncompatibleException {
			...
			try {
				...
				enumParticleClass = PackageType.MINECRAFT_SERVER.getClass("EnumParticle");
				packetClass = PackageType.MINECRAFT_SERVER.getClass(majorVersion == 1 && minorVersion < 7 ? "Packet63WorldParticles" : "PacketPlayOutWorldParticles");
		...
		/**
		 * Returns the major version of your server
		 *
		...
		/**
		 * Returns the minor version of your server (1.x)
		 *
		 * @return The version number
		 */
			...
			try {
				...
				if(majorVersion == 1 && minorVersion > 7) {
					...
					if(data != null) {
						...
						packet.set("k", effect == ParticleEffect.ITEM_CRACK ? packetData : new int[] { packetData[0] | packetData[1] << 12 });
					}
				}
