...
public class Reflect {
    ...
    static final boolean USE_UNSAFE_FINAL_CHANGE_JAVA_12;
    ...
    static {
        boolean supportsFieldModifiers;

        try {
            Field.class.getDeclaredField("modifiers");
            supportsFieldModifiers = true;
        } catch (NoSuchFieldException e) {
            supportsFieldModifiers = false;
            ...
            try {
                ...
                System.err.println("Can't access unsafe and change final fields!");
                ex.printStackTrace();
            }
        }

        USE_UNSAFE_FINAL_CHANGE_JAVA_12 = !supportsFieldModifiers;
    ...
    public Reflect set(String name, Object value) throws ReflectException {
        try {
            ...
            if (isStatic && isFinal && USE_UNSAFE_FINAL_CHANGE_JAVA_12) {
                if (UNSAFE != null) {
